export const ExperiencesData = [
  {
    companyName: "Crayon Data Private Limited",
  ...
  },
  {
    ...
    endDate: "Sept 2023",
    responsibilities: [
      "Developed Angular reactive forms using Form Arrays, streamlining the usage of repeated forms.",
      "Implemented an email scheduler to send reminders to users, enhancing task completion efficiency.",
...
export const AchievementsData = [
  {
    title: "Crayon Leap Award",
    description: "Excellence in Customer Service & Client Delight.",
    date: "H1-2024",
  },
  {
    title: "On the Spot (Team) Award",
    description:
      "Got 100% customer satisfaction index from the customer and appreciation for on-time delivery till date.",
    date: "10/2022",
  },
  {
    title: "On the Spot Achievement Award",
    description:
      "Active role in supporting the team and providing on-time delivery to the client when most of the team members were not available due to Covid-19.",
    date: "06/2021",
  },
  {
    title: "Cricket",
    description:
      "Winner of Inter Districts U-16 Cricket Championship conducted by Tamil Nadu Cricket Association (TNCA).",
    date: "2015",
  },
  {
    title: "Scout and Guides",
    description:
      "Awarded the Rajyapuraskar award during the zonal camp conducted as part of the Scout and Guides movement.",
    date: "2014",
  },
];
